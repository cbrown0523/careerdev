...
console.log(empData)
    ...
    else if(empGen == "M" && empDep == "d001"){
        MMarketing +=1
    }
    else if(empGen == "F" && empDep == "d002"){
        FFinance +=1
    }
    else if(empGen == "M" && empDep == "d002"){
        MFinance +=1
    }
   else if(empGen == "F" && empDep == "d004"){
        FProduction +=1
    }
    else if(empGen == "M" && empDep == "d004"){
        MProduction +=1
    }
   else if(empGen == "M" && empDep == "d005"){
        MDevelopment +=1
    }
    else if(empGen == "F" && empDep == "d005"){
        FDevelopment +=1
    }
   else  if(empGen == "F" && empDep == "d006"){
        FQualityManagement +=1
    }
    if(empGen == "M" && empDep == "d006"){
        MQualityManagement +=1
    }
   else if(empGen == "F" && empDep == "d007"){
        FSales +=1
    }
    else if(empGen == "M" && empDep == "d007"){
        MSales +=1
    }
    else if(empGen == "F" && empDep == "d008"){
        FResearch +=1
    }
    else if(empGen == "M" && empDep == "d008"){
        MResearch +=1
    }
    else if(empGen == "F" && empDep == "d003"){
        FHumanResources +=1
    }
    else if(empGen == "M" && empDep === "d003"){
        MHumanResources +=1
    }
        ...
        \n ${ FCustomerService} females in Customer Service and ${ MFinance} males in Customer Service`
